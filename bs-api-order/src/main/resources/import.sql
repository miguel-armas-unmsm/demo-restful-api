...
INSERT INTO orders(order_id, number, status_code, order_date) VALUES
(1, 'ORD001', 'progress', '2021-11-20'),
(2, 'ORD002', 'finished', '2021-11-20');

INSERT INTO menu_items(menu_item_id, number, name, category_code, description, price, is_active) VALUES
